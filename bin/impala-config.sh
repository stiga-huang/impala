...
export IMPALA_TOOLCHAIN_BUILD_ID=113-f4c9b551a0
...
export IMPALA_ORC_VERSION=1.7.0-p7
...
export IMPALA_THRIFT_VERSION=0.11.0-p4
...
export IMPALA_KUDU_VERSION=${IMPALA_KUDU_VERSION-"67ba3cae45"}
