...
class TestNestedStructsInSelectList(ImpalaTestSuite):
  ...
  @SkipIfFS.hbase
  def test_struct_in_select_list_error(self, vector):
    """Verify error cases that are not supported"""
    self.run_test_case('QueryTest/struct-in-select-list-error', vector)
