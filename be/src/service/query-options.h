...
constexpr unsigned NUM_QUERY_OPTIONS =
    TImpalaQueryOptions::STORE_HISTORICAL_STATS + 1;
#define QUERY_OPTS_TABLE                                                                 \
  ...
  QUERY_OPT_FN(use_historical_stats, USE_HISTORICAL_STATS, TQueryOptionLevel::REGULAR)   \
  QUERY_OPT_FN(                                                                          \
      store_historical_stats, STORE_HISTORICAL_STATS, TQueryOptionLevel::REGULAR)        \
  ;
