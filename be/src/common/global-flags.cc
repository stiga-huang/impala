...
DEFINE_int64(hbo_in_memory_backend_cache_size_bytes, 1024LL * 1024 * 1024,
    "Maximum size in bytes of the HBO in-memory backend (InMemoryCacheBackend, used "
    "for testing). Default is 1GB.");

DEFINE_int32(hbo_in_memory_backend_concurrency_level, 4,
    "Concurrency level for the HBO in-memory backend (InMemoryCacheBackend, used for "
    "testing). Higher values allow more concurrent access but may increase memory overhead.");
